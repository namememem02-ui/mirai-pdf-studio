  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        ...
        {done && <p className="text-green-600 text-sm font-semibold">✅ บันทึกและจัดระเบียบหน้าสำเร็จ — ดาวน์โหลดไฟล์เรียบร้อยแล้ว!</p>}

        <ActionButton onClick={savePdf} disabled={items.length === 0 || busy} busy={busy}>
          💾 บันทึกและดาวน์โหลด PDF ผลลัพธ์ที่ปรับปรุงใหม่ ({items.length} หน้า)
        </ActionButton>
      </div>
    </main>
  );
